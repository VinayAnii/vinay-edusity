  ...
  return (
    <div className='about'>
        ...
        <div className='about-right'>
            ...
            <p>Whether you aspire to becomea teacher, administor, counselor, or educational leader, our diverse
             range of programs offers the perfect pathway to achieve your goals and unlock your full 
